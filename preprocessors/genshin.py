...
#montreal-forced-aligner/bin/mfa_align  /aifs4su/data/zheny/Flashspeech/LibriTTS/LibriTTS /aifs4su/data/zheny/Flashspeech/FastSpeech2/lexicon/librispeech-lexicon.txt /aifs4su/data/zheny/Flashspeech/montreal-forced-aligner/pretrained_models/english.zip /aifs4su/data/zheny/Flashspeech/LibriTTS/LibriTTS_text_grid_11 -j 32 --clean
...
def get_uid2utt(genshin_path, dataset):
    index_count = 0
    total_duration = 0
    ...
    for l in tqdm(dataset):
        ...
        audio_file = items[0]
        text = items[1]
        uid = os.path.basename(audio_file).split(".")[0]
...
def main(output_path, dataset_path):
    ...
    meta_file = os.path.join(genshin_path, "genshin.txt")
    lines = get_lines(meta_file)

    train_set, test_set, valid_set = split_dataset(lines)

    res, hours = get_uid2utt(genshin_path, train_set)
    ...
    res, hours = get_uid2utt(genshin_path, test_set)
    ...
    res, hours = get_uid2utt(genshin_path, valid_set)
